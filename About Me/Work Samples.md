...
This document highlights selected examples of how I think, lead, and build. It is meant to complement my [Management README](./README.md), which explains my leadership style, operating principles, and expectations.
...
An internal SAP AI agent that uses retrieval-augmented generation to search help documentation and can execute runbooks to reduce time to first response and mean time to resolution.

### Knowledge Index

An internal SAP agentic, markdown-based platform that analyzes engineering skills across a team, identifies knowledge gaps, prioritizes them, and creates a plan to address them. This is especially useful for teams with heavy knowledge silos and uneven distribution of critical operational knowledge.

### JIRA Admin / Portfolio Monitor
...
These examples are less about any one tool and more about the patterns behind the work:

- Identifying friction in a workflow and designing a better operating model.
- Using AI to augment decision-making, summarization, orchestration, and execution.
- Building practical internal tools that create leverage for teams.
- Connecting product thinking, technical depth, and team effectiveness.

For the management and leadership side of how I operate, see the [Management README](./README.md).
